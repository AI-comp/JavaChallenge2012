...
import net.javachallenge.entity.Gas
import net.javachallenge.entity.Stone
import net.javachallenge.entity.Metal
...
object ImageLoader {
  ...
  private var _materials: Map[Material, Image] = null

  def loadMaterials(render: Renderer) = {
    if (_materials == null) {
      _materials = Map(Gas -> render.loadImage("img/mat01.png"),
        Stone -> render.loadImage("img/mat02.png"),
        Metal -> render.loadImage("img/mat03.png"))
    }
    _materials
  }
